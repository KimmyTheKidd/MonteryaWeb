  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.h1
            className="text-4xl font-bold text-black mb-8 p-6 bg-white text-black rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl"
