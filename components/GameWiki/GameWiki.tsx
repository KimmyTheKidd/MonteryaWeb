          ...
          >
            ...
            >
              <div className="flex flex-col items-center space-y-4">
                <FontAwesomeIcon icon={card.icon} className="h-12 w-12 text-honey-200" />
                <p className="text-lg font-bold text-honey-200 sm:text-xl">{card.title}</p>
                <p className="text-sm text-night-500 md:text-base md:leading-6">{card.description}</p>
              </div>
            </Card>
          </motion.div>
        ))}
